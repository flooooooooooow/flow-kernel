...
BASE_URLS=(
    "https://distro.ibiblio.org/tinycorelinux/${TC_MAJOR}/x86_64/release/distribution_files"
    "https://mirror.dotsrc.org/mirrors/pub/tinycorelinux/${TC_MAJOR}/x86_64/release/distribution_files"
